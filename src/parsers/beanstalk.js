...
exports.parse = (event) => {
	...
	if (
		!_.has(message, "Message") ||
		!_.has(message, "Application") ||
		!_.has(message, "Environment") ||
		!_.has(message, "Timestamp")
	) {
	...
	const failedQuota = _.includes(
		text,
		"Your quota allows for 0 more running instance",
	);
	const unsuccessfulCommand = _.includes(
		text,
	...
	const abortedDeployment = _.includes(
		text,
