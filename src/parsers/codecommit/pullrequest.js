...
exports.matches = (event) =>
	...
	_.get(event.message, "detail-type") ===
...
exports.parse = (event) => {
	...
	const pullRequestUrl = event.consoleUrl(
		`/codecommit/home#/repository/${repoName}/pull-request/${pullRequestId}`,
	);
	const fields = [];
	...
	let title = baseTitle;
	if (
		pullRequestEvent === "pullRequestMergeStatusUpdated" &&
		...
		pullRequestEvent === "pullRequestStatusChanged" &&
		pullRequestStatus === "Closed" &&
