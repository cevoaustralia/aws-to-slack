...
test(`EventDef creates console links`, () => {
	...
	expect(evt.consoleUrl("/foo")).toEqual(
		"https://console.aws.amazon.com/foo?region=us-west-7",
	);
	expect(evt.consoleUrl("/ec2/home#goal:7")).toEqual(
		"https://console.aws.amazon.com/ec2/home?region=us-west-7#goal:7",
	);
	expect(evt.consoleUrl("/ec2/home?region=us-west-1#goal:7")).toEqual(
		"https://console.aws.amazon.com/ec2/home?region=us-west-1#goal:7",
	);
	expect(evt.getLink("Test text", "https://example.com").toString()).toEqual(
