...
const pipeExample = {
	...
	region: "us-east-1",
	resources: ["arn:aws:codepipeline:us-east-1:111111111111:my-pipeline"],
	detail: {
...
const actionExample = {
	...
	region: "us-east-1",
	resources: ["arn:aws:codepipeline:us-east-1:012345678901:foo-pipeline"],
	detail: {
...
const exampleApprovalRequest = {
	region: "us-east-1",
	consoleLink:
		"https://console.aws.amazon.com/codepipeline/home?region=us-east-1#/view/mypipeline.name",
	approval: {
		...
		approvalReviewLink:
			"https://console.aws.amazon.com/codepipeline/home?region=us-east-1#/view/mypipeline.name/Deploy/Deploy_Approval/approve/abcdefgh-b2fb-1234-a00a-31a03b998faa",
		customData:
			"TESTING :: Manual approval for a deployment to mypipeline.name",
	},
};
